module.exports.models = {
  // Default attributes to implicitly include in all of your app's model definitions. (Can be overridden on an attribute-by-attribute basis.)
  // @url https://sailsjs.com/documentation/concepts/models-and-orm/attributes

  attributes: {},

  // The auto-migration strategy for your Sails app. How & whether Sails will attempt to automatically rebuild the tables/collections/etc. in your schema every time it lifts.
  migrate: "alter",

  /**
   * Only relevant for models hooked up to a schemaless database like MongoDB. If set to true, then the ORM will switch into "schemaful" mode. For example, if properties passed in to .create(), .createEach(), or .update() do not correspond with recognized attributes, then they will be stripped out before saving.
   */
  schema: false,
